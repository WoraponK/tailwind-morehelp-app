...
function Header() {
    return (
        <header className='pt-8 space-y-6'>
            ...
            <div className='text-base-content text-lg flex justify-center items-center py-2'>
                <p className='text-center w-3/4'>Need some help? Forgot the property names? This can help you from many classes from tailwind!</p>
            </div>
        </header>
    )
}
